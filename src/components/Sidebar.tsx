...
interface SidebarProps {
  activeView: 'dashboard' | 'analytics' | 'tasks' | 'projects';
  onViewChange: (view: 'dashboard' | 'analytics' | 'tasks' | 'projects') => void;
}
...
export const Sidebar: React.FC<SidebarProps> = ({ activeView, onViewChange }) => {
  ...
  return (
    <aside className="w-72 bg-sidebar border-r border-white/5 flex flex-col p-6 h-full relative z-20">
      {/* Brand */}
      <motion.div
